...
.testimonials-section {
    ...
    position: relative;
    z-index: 2;
    background: linear-gradient(135deg, #0d0520 0%, #130a35 40%, #0a1a40 70%, #0d0a2e 100%);
    overflow: hidden;
}
...
.testi-orb { position: absolute; border-radius: 50%; filter: blur(90px); pointer-events: none; }
.testi-orb-1 { width: 500px; height: 500px; background: rgba(224,64,251,0.1); top: -150px; left: -100px; }
.testi-orb-2 { width: 400px; height: 400px; background: rgba(37,99,235,0.1); bottom: -100px; right: -80px; }
.testi-orb-3 { width: 280px; height: 280px; background: rgba(249,115,22,0.07); top: 40%; right: 15%; }
.testi-dots-bg {
...
.testi-header p { font-size: 16px; line-height: 1.8; color: rgba(255,255,255,0.5); max-width: 480px; margin: 0 auto; }
...
.testi-summary-stat .ts-num {
    font-family: 'Clash Display', sans-serif; font-weight: 700; font-size: 38px;
    background: var(--grad-main); -webkit-background-clip: text;
    -webkit-text-fill-color: transparent; background-clip: text;
    line-height: 1; margin-bottom: 4px;
}
.testi-summary-stat .ts-lbl { font-size: 12px; color: rgba(255,255,255,0.4); font-weight: 600; letter-spacing: 0.5px; }
.testi-summary-divider { width: 1px; height: 50px; background: rgba(255,255,255,0.1); }
.testi-overall-rating { display: flex; flex-direction: column; align-items: center; gap: 8px; }
.testi-stars-row { display: flex; gap: 4px; }
.testi-overall-rating span { font-size: 12px; color: rgba(255,255,255,0.4); font-weight: 600; }
...
.testimonial-card:hover {
    ...
    box-shadow: 0 24px 60px rgba(0,0,0,0.3), 0 0 0 1px rgba(124,58,237,0.2);
}
.testimonial-card:hover::before { opacity: 1; }
.tcard-quote-mark {
    position: absolute; top: 18px; right: 22px;
    font-family: 'Clash Display', 'Georgia', serif; font-size: 90px; line-height: 1;
    background: var(--grad-main); -webkit-background-clip: text;
    -webkit-text-fill-color: transparent; background-clip: text;
...
.tcard-profile { display: flex; align-items: center; gap: 14px; }
.tcard-avatar-wrap { position: relative; flex-shrink: 0; }
.tcard-avatar {
    width: 62px; height: 62px; border-radius: 50%;
    overflow: hidden;
    border: 2.5px solid rgba(255,255,255,0.18);
    box-shadow: 0 0 0 3px rgba(124,58,237,0.2), 0 6px 24px rgba(0,0,0,0.45);
    background: #1a0f3c; display: block;
}
.tcard-avatar img {
...
.testimonial-card:hover .tcard-avatar img { transform: scale(1.06); }
.tcard-verified {
    position: absolute; bottom: -2px; right: -2px;
    width: 20px; height: 20px; border-radius: 50%;
    background: #2563eb; border: 2px solid #0d0520;
    display: flex; align-items: center; justify-content: center;
}
.tcard-verified svg { width: 10px; height: 10px; stroke: white; stroke-width: 3; fill: none; }
.tcard-info h4 { font-family: 'Clash Display', sans-serif; font-weight: 700; font-size: 16px; color: white; margin-bottom: 3px; line-height: 1; }
.tcard-info span { font-size: 12px; color: rgba(255,255,255,0.4); font-weight: 500; }
.tcard-stars { display: flex; gap: 2px; flex-shrink: 0; }
.tcard-text { font-size: 15px; line-height: 1.85; color: rgba(255,255,255,0.65); flex: 1; margin-bottom: 24px; position: relative; z-index: 1; }
.tcard-tags { display: flex; gap: 8px; flex-wrap: wrap; margin-bottom: 22px; }
.tcard-tag { display: inline-flex; align-items: center; gap: 5px; padding: 5px 12px; border-radius: 50px; font-size: 11px; font-weight: 700; letter-spacing: 0.3px; }
.tag-purple { background: rgba(124,58,237,0.2); border: 1px solid rgba(124,58,237,0.3); color: #c4b5fd; }
.tag-orange { background: rgba(249,115,22,0.15); border: 1px solid rgba(249,115,22,0.3); color: #fdba74; }
.tag-teal   { background: rgba(6,182,212,0.12);  border: 1px solid rgba(6,182,212,0.25);  color: #67e8f9; }
.tag-green  { background: rgba(16,185,129,0.12); border: 1px solid rgba(16,185,129,0.25); color: #6ee7b7; }
.tag-pink   { background: rgba(224,64,251,0.12); border: 1px solid rgba(224,64,251,0.25); color: #f0abfc; }
.tcard-footer { display: flex; align-items: center; justify-content: space-between; padding-top: 18px; border-top: 1px solid rgba(255,255,255,0.07); }
.tcard-date { font-size: 11px; color: rgba(255,255,255,0.25); font-weight: 500; }
.tcard-platform { display: flex; align-items: center; gap: 6px; font-size: 11px; color: rgba(255,255,255,0.3); font-weight: 600; }
...
.testimonial-card.featured .tcard-text { font-size: 16px; }
.testimonial-card.featured .tcard-avatar {
    width: 72px; height: 72px;
    border-color: rgba(124,58,237,0.5);
    box-shadow: 0 0 0 4px rgba(124,58,237,0.2), 0 6px 28px rgba(0,0,0,0.5);
}
.testi-bottom { display: flex; align-items: center; justify-content: space-between; padding-top: 16px; flex-wrap: wrap; gap: 20px; }
.testi-avatars { display: flex; align-items: center; }
.testi-avatar-mini {
    width: 38px; height: 38px; border-radius: 50%;
    overflow: hidden; border: 2.5px solid #130a35;
    margin-left: -10px; background: var(--grad-main); flex-shrink: 0;
}
.testi-avatar-mini:first-child { margin-left: 0; }
.testi-avatar-mini img { width: 100%; height: 100%; object-fit: cover; object-position: center top; display: block; }
.testi-avatar-mini.more {
    display: flex; align-items: center; justify-content: center;
    font-family: 'Clash Display', sans-serif; font-weight: 700; font-size: 12px;
    color: white; background: var(--grad-warm);
}
.testi-more-text { margin-left: 14px; font-size: 13px; color: rgba(255,255,255,0.45); }
.testi-more-text strong { color: white; font-family: 'Clash Display', sans-serif; }

@media(max-width: 992px) {
    .testimonials-grid { grid-template-columns: 1fr; }
    .testimonial-card.featured { grid-column: span 1; }
    .testi-summary { gap: 20px; }
}
